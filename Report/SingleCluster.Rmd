...
load(paste0("../",pathRdata,"/ClusterAnalysisPostEndDate",Cut,"_p", params$p,".RData") )
source(paste0("../",pathRdata,"/../DataPreparation.R") )

## Seleziono solo il cluster 4 del post before EndDate 
...
#ggplotly(pl)
file= paste0("ClusterAnalysisPostEndDate",Cut,"G",params$Gpost,"_cl",ClusterName,"_p",params$p,".RData")
...
FileNameSave = paste0("../",pathRdata,"/AnalysisCluster",params$Cut,"Post",ClusterName,"_G",params$Gselected,"_FromG",params$Gpost,"_p", params$p,".RData")
